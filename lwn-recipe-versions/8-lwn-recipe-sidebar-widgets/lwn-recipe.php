...
{
    load_plugin_textdomain('lwn-recipe', false, dirname(plugin_basename(__FILE__)) . '/languages');
}
...
function lwn_recipe_public_styles()
{
    ...
    if (is_post_type_archive('lwn_recipe') || is_tax('lwn_recipe_type')) {
        wp_enqueue_style('lwn_recipe_css', plugins_url('public/css/archive.min.css', __FILE__));
    }
}
