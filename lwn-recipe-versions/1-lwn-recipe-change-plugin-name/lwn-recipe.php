...
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/recipe-custom-post.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/recipe-custom-taxonomy.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/general-meta-box.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/details-meta-box.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/save-meta-box.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/add-recipe-template.php');
require_once(LWN_RECIPE_PLUGIN_PATH. 'includes/add-shortcode.php');
