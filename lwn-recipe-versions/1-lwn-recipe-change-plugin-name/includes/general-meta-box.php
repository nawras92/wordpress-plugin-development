...
add_action('admin_init', 'lwn_recipe_general_info_box');


function lwn_recipe_general_info_box()
{
    add_meta_box(
        'lwn-recipe-general-info',
        __('Recipe General Info', 'lwn-recipe'),
        'lwn_recipe_display_general_info_box',
        'lwn_recipe',
        'normal',
        'high'
    );
...
function lwn_recipe_display_general_info_box($recipe)
{
